...
// splice ; 배열 요소 인출 후 삭제, 추가를 동시에 할 수 있는 메소드
fruits = ["Apple","Banana","Carot","Durian"]
console.log(fruits)

console.log("-----------인수 1개 splice")
console.log(fruits.splice(2)) // 인수가 1개 -> 시작인덱스부터 끝까지 추출
console.log(fruits)

fruits = ["Apple","Banana","Carot","Durian"]
console.log(fruits)
console.log("-----------인수 2개 splice")
// 인수가 2개 -> 시작인덱스, 갯수
...
// 인수가 3개 이상 -> 시작인덱스, 갯수, 추가할 요소
console.log("------------인수 3개 splice")
...
const str = "Hello, my name is JungWoochan JavaScript master"
...
fruits.sort() // 정렬 : 오름차순
console.log(fruits)
// 정렬 규칙을 정하려고 할 때 : 정렬 기준 함수 매개변수로 전달 해줘야 함
fruits = ["Carot","Durian","Apple","Mango","Kiwi","Banana"]
